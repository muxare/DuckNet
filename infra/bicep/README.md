...
Checked-in Bicep is the source of truth ([decision](../../docs/decisions/iac-bicep-vs-pulumi.md)). **Compile here; apply in 12c.** No subscription is required for this step. Why these resources and not the alternatives: [design rationale](../../docs/design-rationale.md). How to apply once: [azure-first-deploy.md](../../docs/azure-first-deploy.md).
